...
function loadExpenseData(page, recordNumber, c)
{
    ...
    xmlhttp.open("GET", "UserEatingStatistical/model/loadExpenseData.php?page="+page+"&recordNumber="+recordNumber+"&c='%"+c+"%'&year="+year+"&month="+month, true);
    xmlhttp.send();
...
function deleteAnExpense(dishNumber)
{
    ...
    {
        xmlhttp.open("GET", "UserEatingStatistical/model/deleteADish.php?dishNumber=" + dishNumber, true);
