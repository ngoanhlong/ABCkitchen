...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/JsMadeByLongNA.js"></script>
        ...
        <script src="js/CreateMenuLoadAjax.js"></script>
            ...
            <div class="wrap">
                <div class="top-header">
                    ...
                    <div class="social-icons">
                        <h5 style="color: whitesmoke">Xin chào <span style="color: red;"><?php echo $greeting.' '.$_SESSION['userName'];
?>,</span> </h5>
                ...
                <div class="top-nav">
                    <div class="top-nav-left">
                        <ul>
                            ...
                            <li class="active"><a href="gallery.php">Đăng kí ăn</a></li>
        ...
        <div class="content" >
            ...
            <div class="gallerys">
                <div class="wrap">
                    <h2 style="color: green;">Chọn ngày muốn đăng kí ăn:</h2>
                    <br>
                    <br>
                    <h4>Đây là thực đơn của ngày hôm </h4><span><input type="date" id="myTime" value="<?php date_default_timezone_set("Asia/Ho_Chi_Minh");
                                echo date("Y-m-d");
                                ?>" onchange="showPage(1)"/></span>
                    
                    
                    <div id="loadAllDish" data-ng-app="">
