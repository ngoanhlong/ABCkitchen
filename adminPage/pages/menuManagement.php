    ...
    <body  onload="loadData()">
        ...
        <div id="wrapper" >
            ...
            <div id="page-wrapper" >
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Quản lí thực đơn</h1>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group" >
                            <label for="menu">Chọn ngày muốn lập menu: &nbsp;&nbsp;&nbsp;</label>
        ...
        <script src="../menuManagement/control/loadData.js"></script>
        <script src="../menuManagement/control/JSInputValidation.js">
        </script>
        <script src="../menuManagement/control/JsMadeByLongNA.js"></script>
        <script>
