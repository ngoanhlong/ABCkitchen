    ...
    <body  onload="loadData()">
        ...
        <div id="wrapper" >
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="../../LongNALoginPage.php"><i class="fa fa-sign-out fa-fw"></i> Đăng xuất</a>
                            </li>
                        </ul>
                        <!-- /.dropdown-user -->
                    </li>
            ...
            <div id="page-wrapper" >
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Chuẩn bị thực phẩm</h1>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group" >
                            <label for="menu">Xem thực đơn tại ngày: &nbsp;&nbsp;&nbsp;</label>
                            <input id="menu" type="date" onchange="loadMenuData(1,this.value)" value="<?php
                        ...
                        <div class="gallerys">
                            ...
                            <!--<div class="wrap">-->
                                ...
                                <div class="well" id="loadMenuData">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="" id="sel1" onchange="loadDishMenuData(1, this.value, '')">
                                        <option>5</option>
                                    ...
                                    <div class="col-md-4" style="float:right;">
                                        <input class="form-control" type="text" id="searchDish" onkeyup="loadDishMenuData(1, 10, this.value)"/>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="dataTable_wrapper" id="loadDishMenuData">
        ...
        <script src="../foodPreparation/control/loadData.js"></script>
        <script src="../foodPreparation/control/JSInputValidation.js">
        </script>
        <script src="../foodPreparation/control/JsMadeByLongNA.js"></script>
        <script>
